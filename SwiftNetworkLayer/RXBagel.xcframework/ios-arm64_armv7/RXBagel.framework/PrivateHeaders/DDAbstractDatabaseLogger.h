...
@property (nonatomic, assign) NSUInteger saveThreshold;
@property (nonatomic, assign) NSTimeInterval saveInterval;
@property (nonatomic, assign) NSTimeInterval maxAge;
@property (nonatomic, assign) NSTimeInterval deleteInterval;
@property (nonatomic, assign) BOOL deleteOnEverySave;

@property (nonatomic, assign) BOOL saveTimerSuspended;
@property (nonatomic, assign) NSUInteger unsavedCount;
@property (nonatomic, assign) dispatch_time_t unsavedTime;
@property (nonatomic, strong) dispatch_source_t saveTimer;
@property (nonatomic, assign) dispatch_time_t lastDeleteTime;
@property (nonatomic, strong) dispatch_source_t deleteTimer;
/**
