...
@property (nonatomic, assign) char *app;
@property (nonatomic, assign) size_t appLen;

@property (nonatomic, strong) NSString *processID;
@property (nonatomic, assign) char *pid;
@property (nonatomic, assign) size_t pidLen;

@property (nonatomic, assign) BOOL colorsEnabled;
@property (nonatomic, strong) NSMutableArray *colorProfilesArray;
