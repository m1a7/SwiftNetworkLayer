...
@property (nonatomic, strong) DDLogFileInfo *currentLogFileInfo;
@property (nonatomic, strong) NSFileHandle *currentLogFileHandle;
@property (nonatomic, strong) dispatch_source_t currentLogFileVnode;
@property (nonatomic, strong) dispatch_source_t rollingTimer;
